...
def save_code_blocks(code_blocks, output_dir, file_extension=".py"):
    """
    Save each code block to a new file. File names are generated by cycling
...
def process_json_file(json_path, output_dir, language="python", file_extension=".py"):
    """
    ...
    if not all_code_blocks:
        ...
        save_code_blocks(all_code_blocks, output_dir, file_extension)
...
def main():
    ...
    # TODO: Add support for other languages that they will determined by the --language flag automatically  
    parser.add_argument(
        "-f", "--fileExtension",
        default=".py",
        help="File extension for saved files (default: .py)"
    )
    args = parser.parse_args()

    process_json_file(args.json_file, args.output_dir, args.language, args.fileExtension)
