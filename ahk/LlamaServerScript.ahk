...
#F11::
    ...
    if (LlamaRunning = 0) {
        ...
        CmdLine := "cmd.exe /k set CUDA_VISIBLE_DEVICES=-0 && " . LlamaPath . "\build\bin\Release\llama-server --model " . LlamaPath . "\..\models\gemma-3-1b-it-Q4_K_M.gguf --n-gpu-layers 420"
